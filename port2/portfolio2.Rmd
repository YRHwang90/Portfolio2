...
\beta_{p5}(verb1)_{ij}+e_{vj}) +  PerformOn_{ij}*(\beta_{p3}+\beta_{p4}(perform1)_{ij}+
...
Acutally, in the tutorial, it is said that
Residual standard error: 7.545255  <- this is the SE for verbal scores and 
7.545255 x Rho = 7.545255 x 0.31 = 8.98 is performance scores' estimated SE. 
I do not cleary understand this.

Thus,(not in the very next portforlio, but soon...) I will do the dyadic analysis again with different approaches. 
